defmodule TreasuryWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "enabled:hover:outline-emerald-400/80 outline-emerald-300 ",
        "enabled:active:outline-emerald-400/80 text-emerald-100 enabled:active:text-emerald-400/80",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TreasuryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TreasuryWeb.Gettext, "errors", msg, opts)
    end
  end
